/*
 * Replay readable unpacker model from a single start offset and dump output.
 */
...
#include "../logic/entry_unpacker_readable.h"
...
int main(int argc, char **argv) {
    ...
    ok = otrail_entry_unpacker_readable_mode(
        file_buf + offset,
        file_size - offset,
        dst,
        dst_cap,
    ...
    snprintf(out_path, sizeof(out_path), "build/replay_readable_0x%X.bin", offset);
